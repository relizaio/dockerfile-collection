...
func init() {
	...
	pgCmd.PersistentFlags().Bool("verify-restore", false, "audit-rotate: before dropping, re-download the archive and match its SHA-256 against the recorded digest (costs a full re-download) (ENV: VERIFY_RESTORE)")
