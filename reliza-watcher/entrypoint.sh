...
send_data () {
    ...
    for ns in "${NAMESPACES[@]}"; do
        ...
        then
            ...
            ./reliza-cli instdata -u $relizaHubUri -i $RELIZA_API_ID -k $RELIZA_API_KEY --sender $SENDER_ID$ns --namespace $ns --imagestyle k8s --imagefile ./resources/images_to_send
